  ...
  return (
    <div style={{ perspective: 2000 }}>
      <motion.div
        ...
        className="w-[426px] min-h-[600px] bg-[#e4dfdc] rounded-[30px] px-[40px] py-[24px] cursor-grab relative"
      >
        <div>
          <img src={Logo} alt="" />
        </div>
        ...
        <div className="flex item-center gap-x-[20px] mb-12">
        ...
        >
          <img src={NikeImg} alt="" draggalbe="false" />
        </motion.div>
      </motion.div>
    </div>
  );
